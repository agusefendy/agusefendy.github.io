              ...
              <div className="p-5 sm:p-8">
                <div className="columns-1 gap-5 sm:columns-2 sm:gap-8 md:columns-2 lg:columns-2 [&>img:not(:first-child)]:mt-8 animate__animated animate__fadeInUp">
                  {imageDetail.map((image, index) => (
                    <div key={index}>
                      <img
                        src={"/img/portfolioDetail/" + image}
                        className="h-auto max-w-full rounded-lg mb-4 transform hover:scale-110 transition duration-300 ease-in-out"
                      />
                    </div>
                  ))}
                </div>
            ...
            <div className="w-full px-4 lg:w-1/2 animate__animated animate__fadeInUp">
              ...
              <div className="mt-3">
                <a
                  href={source}
                  target="_blank"
                  className="text-base font-semibold text-white bg-primary py-2 px-4 mr-2 rounded hover:shadow-lg hover:opacity-80"
                >
                  source code
                </a>
                {demo && (
