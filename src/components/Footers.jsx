        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full px-4 mb-12 font-medium text-slate-300 md:w-1/3">
              <h2 className="font-bold text-4xl text-white mb-5">Agos</h2>
            ...
            <div className="w-full px-4 mb-12 md:w-1/3">
              ...
              <div className="flex flex-wrap">
                <a
                  href=""
                  className="max-w-[120px] mx-6 py-4 grayscale opacity-60 transition duration-500 hover:grayscale-0 hover:opacity-100"
                >
                  <img
